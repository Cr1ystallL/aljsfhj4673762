...
from handlers import basic, payment, admin, referral, emergency, inline
...
async def main():
    ...
    # Регистрация роутеров (только базовые, админка, платежи, рефералка, инлайн — игры только в Mini-App)
