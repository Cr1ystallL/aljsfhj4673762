      ...
      <div className="mx-auto w-full max-w-[800px] px-3 pt-3 pb-28 flex flex-col gap-4">
        ...
        <div className="w-full rounded-3xl border border-white/10 bg-[#0d0d12]/90 p-5 backdrop-blur-2xl shadow-[0_8px_32px_0_rgba(0,0,0,0.8)] flex flex-col gap-4 relative overflow-hidden">
          ...
          <div className="flex items-center justify-between gap-2 border-b border-white/5 pb-3 relative">
            {/* Left: Total Pot (Flame box 1x size) */}
            <div className="flex items-center gap-2.5">
              <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-2xl bg-amber-400/10 border border-amber-400/25 flex items-center justify-center text-amber-400 shadow-md shrink-0">
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 flex items-center justify-center pointer-events-none z-10">
              {state?.phase === 'spinning' ? (
                ...
                <span
                  className={
                    timeLeft === 3
                      ? 'text-red-500 text-3xl sm:text-5xl font-black font-mono scale-125 drop-shadow-[0_0_25px_rgba(239,68,68,0.95)] transition-all'
                      : timeLeft === 2
                      ? 'text-amber-400 text-3xl sm:text-5xl font-black font-mono scale-125 drop-shadow-[0_0_25px_rgba(245,158,11,0.95)] transition-all'
                      : timeLeft === 1
                      ? 'text-emerald-400 text-3xl sm:text-5xl font-black font-mono scale-125 drop-shadow-[0_0_25px_rgba(16,185,129,0.95)] transition-all'
                      : 'text-white text-2xl sm:text-4xl font-black font-mono tracking-wider'
                  }
                >
                  {timeLeft}
                </span>
