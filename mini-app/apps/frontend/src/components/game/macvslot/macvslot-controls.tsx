        ...
        {isFreeSpinActive ? (
          ...
          <>
            ...
            <div className="flex items-center justify-between gap-1.5 p-1.5 rounded-2xl bg-[#080a0f]/92 border border-amber-500/25 backdrop-blur-xl shadow-lg">
              {/* 1. Left: Bet Selector + 3-Stripes Menu Button */}
              <div className="flex items-center gap-1 shrink-0">
                <button
                  type="button"
                  onClick={() => setShowBetMenu((prev) => !prev)}
                  className="w-7 h-7 rounded-lg bg-zinc-800/90 hover:bg-zinc-700 active:scale-95 flex items-center justify-center text-amber-400 border border-amber-500/30 transition-all cursor-pointer shadow-md"
        ...
        {isFreeSpinActive ? (
          ...
          <>
            ...
            <div className="flex items-center gap-2 sm:gap-3 shrink-0">
              {/* 3-Stripes Hamburger Menu Button */}
              <button
                type="button"
                onClick={() => setShowBetMenu((prev) => !prev)}
