...
import { BetPanelShell, BetPanelCtaRow, GamePrimaryButton } from '@/components/game/kit';
  ...
  return (
    <BetPanelShell>
      <div className="p-4 flex flex-col gap-3">
        {/* Row 1: Bet Amount & Risk Selector Dropdown */}
        <div className="grid grid-cols-[1.4fr_1fr] gap-2 items-end">
          ...
          <div className="space-y-1">
            ...
            <div className="relative flex items-center bg-white/[0.04] border border-white/10 rounded-xl focus-within:border-amber-400/50 transition-colors h-10 px-2.5">
          ...
          <div className="space-y-1 relative" ref={dropdownRef}>
            ...
            <button
              ...
              className="w-full h-10 px-2.5 rounded-xl border border-white/10 bg-white/[0.04] hover:bg-white/[0.08] active:scale-[0.98] flex items-center justify-between text-white text-xs font-medium transition-all disabled:opacity-50"
            >
        ...
        <div className="grid grid-cols-2 gap-2">
          <Button
            ...
            disabled={disabled}
            onClick={onAutoPick}
            className="h-9 rounded-xl border-white/10 bg-white/[0.03] hover:bg-white/10 text-white/80 text-xs font-roobert"
          >
            <Dice5 className="w-3.5 h-3.5 mr-1.5 text-amber-400" />
            Автовыбор
          </Button>
          <Button
            variant="secondary"
            ...
            onClick={onClear}
            className="h-9 rounded-xl border-white/10 bg-white/[0.03] hover:bg-destructive/20 hover:text-destructive text-white/80 text-xs font-roobert"
          >
