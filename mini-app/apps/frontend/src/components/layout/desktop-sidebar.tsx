...
export function DesktopSidebar() {
  ...
  return (
    <aside className="hidden lg:flex w-72 bg-black border-r border-white/10 flex-col justify-between p-4 flex-shrink-0 sticky top-0 h-screen z-40 overflow-y-auto no-scrollbar selection:bg-amber-500/30">
