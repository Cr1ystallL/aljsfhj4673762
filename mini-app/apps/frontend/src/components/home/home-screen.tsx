...
const GAME_COL_SPAN: Record<string, string> = {
  // 3x3 Grid: Row 1 (MacvJet, BlackJack, Mines), Row 2 (Wheel, Case, Coinflip), Row 3 (Keno, HiLo, MacvPot)
  crash: 'col-span-1',
  blackjack: 'col-span-1',
  mines: 'col-span-1',
  wheel: 'col-span-1',
  cases: 'col-span-1',
  coinflip: 'col-span-1',
