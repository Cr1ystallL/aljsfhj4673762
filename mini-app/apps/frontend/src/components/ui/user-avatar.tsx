...
export function UserAvatar({
  ...
  return (
    <div className={`relative shrink-0 select-none ${config.container} ${className}`}>
      {avatarFrame}
      {showBadge && badgePlacement === 'corner' && (
